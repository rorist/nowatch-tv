...
public class DB extends SQLiteOpenHelper {
    ...
    private final String CREATE_FEEDS = "create table feeds (_id INTEGER PRIMARY KEY, title TEXT, summary TEXT, link TEXT, pubDate NUMERIC, image BLOB);";
    private final String CREATE_ITEMS = "create table items (_id INTEGER PRIMARY KEY, feed_id INTEGER, title TEXT, summary TEXT, link TEXT, pubDate NUMERIC, file_uri TEXT, file_size INTEGER, file_type TEXT);";
